...
public class Frame1 extends JFrame{
   ...
   public Frame1(){
		...
		//Background
		this.background = new JLabel(new ImageIcon("src/image/burger.jpg"));
    ...
    public void init(){
		...
		this.headerLabel.setText("EXOTIC CAFE");
		this.headerLabel.setBounds(270,1,200,100);
		this.headerLabel.setFont(new Font("Geomanist", Font.BOLD, 26));
